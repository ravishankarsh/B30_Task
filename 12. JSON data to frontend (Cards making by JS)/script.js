...
users.forEach(function(elem){
    container += `<div id="box">
        <div id="cover"><img src="${elem.coverPhoto}" alt=""></div>
        <div id="profile"><img src="${elem.profilePhoto}" alt=""></div>
        <h1>${elem.username}</h1>
        <h2>${elem.fullName}</h2>
        <h3>${elem.description}</h2>
        <div class="line"></div>
        <div id="num"><h1>${elem.mediaUploadedCount}</h1><h1>${elem.followersCount}</h1><h1>${elem.followingCount}</h1></div>
        <div id="follow"><h3>Media</h3><h3>Followers</h3><h3>Following</h3></div>
    </div>`
